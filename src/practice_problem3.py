...
def is_prime(n):
    ...
    # ------------------------------------------------------------------
    # Students:
    #   Do NOT touch the above  is_prime  function - it has no TODOs.
...
def practice_problem3e(sequence):
    ...
    for k in range(length):
        even_sum = even_sum + sequence[2 * k]
    return even_sum
